...
# - use the VERSION as arg of the bundle target (e.g make bundle VERSION=0.0.51)
# - use environment variables to overwrite this value (e.g export VERSION=0.0.51)
VERSION ?= 0.0.51
...
# greedykomodo/redis-operator-bundle:$VERSION and greedykomodo/redis-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= greedykomodo/redis-operator
