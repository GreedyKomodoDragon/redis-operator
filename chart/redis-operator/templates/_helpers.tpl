...
*/}}
{{- define "redis-operator.clusterRoleName" -}}
{{- include "redis-operator.fullname" . }}-manager-role
{{- end }}

{{/*
Create the name of the cluster role binding to use
*/}}
{{- define "redis-operator.clusterRoleBindingName" -}}
{{- include "redis-operator.fullname" . }}-manager-rolebinding
{{- end }}

{{/*
Create the name of the leader election role to use
*/}}
{{- define "redis-operator.leaderElectionRoleName" -}}
{{- include "redis-operator.fullname" . }}-leader-election-role
{{- end }}

{{/*
Create the name of the leader election role binding to use
*/}}
{{- define "redis-operator.leaderElectionRoleBindingName" -}}
{{- include "redis-operator.fullname" . }}-leader-election-rolebinding
{{- end }}
